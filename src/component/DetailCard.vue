...
<template>
    <div id="background-card" class="w-full h-full flex justify-center items-center top-0 left-0 bg-gray-800/50 
     lg:bg-transparent lg:justify-start lg:items-start lg:w-1/2 lg:left-1/2 lg:top-24 lg:mx-20 
     flex-1 fixed ">
        <div
            class="relative w-full md:w-2/3 max-w-sm flex flex-col items-center rounded-3xl gap-4 bg-white shadow-lg py-14 px-12">
            <img class="w-32 absolute -top-14" :src="data.imgUrl">
            ...
            <div @click="closeDetail()" class="cursor-pointer">
                <img src="./icons/close.svg" alt="close-icon" class="absolute top-4 right-4">
            </div>
        </div>
    </div>
</template>